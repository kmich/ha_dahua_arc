...
The main CI runs Python 3.14 compile, Ruff, protocol and area unit tests, Home Assistant 2026.9 runtime/config-flow tests, Hassfest, HACS validation, package checks, and targeted security lint. A passing CI run does not replace an on-hardware soak test for the ARC3800H. Coverage is reported as measured; this project does not claim 95% protocol-engine coverage.
